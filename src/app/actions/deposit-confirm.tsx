    ...
    <View className="flex-1 bg-surface">
      <SafeAreaView className="flex-1" edges={['top']}>
        ...
        <View className="flex-row items-center justify-between px-4 pt-2 pb-4">
          ...
          <Text className="text-white text-base font-semibold">Confirm Deposit</Text>
          ...
          <View className="items-center px-5 mt-4 gap-3">
            <View className="w-20 h-20 rounded-full bg-green-400/10 items-center justify-center">
              <View className="w-16 h-16 rounded-full bg-green-400/20 items-center justify-center">
                <IconArrowDown size={30} color="#4ade80"/>
              </View>
            </View>

            <Text className="text-neutral-400 text-sm">You're depositing</Text>
          ...
          <Pressable onPress={handleConfirm}>
            ...
            >
              ...
              <Text className="text-black text-base font-bold">
                Confirm & Deposit ${formatCurrency(total)}
              </Text>
            </LinearGradient>
          </Pressable>
        </View>
